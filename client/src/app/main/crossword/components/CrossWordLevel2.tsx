...
export default function CrossWordLevel2() {
  const rows = 6;
  const cols = 6;

  // Mongolian words + images
  const words: Word[] = [
    { word: "цэцэг", image: "/images/flower.jpg" },
    { word: "цоож", image: "/images/lock.png" },
    { word: "загас", image: "/images/fish.png" },
    { word: "үзэг", image: "/images/pen.jpg" },
    { word: "зоос", image: "/images/coin.jpg" },
    { word: "дээл", image: "/images/deel.webp" },
    { word: "зүү", image: "/images/needle.png" },
  ...
  function generateGrid(r: number, c: number, wordList: string[]): Cell[][] {
    const letters = "аэиоуөүдбгтцзж"; // allowed letters
