          ...
          <div className="flex-1 flex flex-col items-center">
            <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 shadow-lg">
              ...
              <div className="mt-4 flex items-center justify-center gap-6">
                <button
                  onClick={() => router.push("/")}
                  className="w-16 h-12 bg-indigo-400 text-white rounded-lg shadow-lg hover:bg-indigo-500 flex items-center justify-center"
                >
                  <ArrowLeft className="w-6 h-6" />
                </button>
                <button
                  onClick={resetGame}
                  className="w-16 h-12 bg-gray-400 text-white rounded-lg shadow-lg hover:bg-gray-500 flex items-center justify-center"
                >
                ...
                <button
                  ...
                  className={`w-16 h-12 rounded-lg shadow-lg flex items-center justify-center ${
                  ...
                  >
                    ...
                    >
                      <Image
                        ...
                        width={80}
                        height={80}
                        className="w-full h-20 object-cover group-hover:brightness-105"
                      />
                      {foundWords.includes(w.word) && (
